...
/*
    ...
    Не понятно каким образом решать вопрос скейлинга изображения если эталон n на n а вход m на m, относительными величинами или усреднением или еще чем-то или метод сравнивания изменять.
...
*/
var bmpImage = BmpImage.Load("precalculated-digit0.bmp");

var inputHor = bmpImage.CountBlackPixelsByRow();
var inputVer = bmpImage.CountBlackPixelsByColumn();
